                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 p-0">
                        <ul class="header__info">
                            ...
                            <li><a
                                    href="https://themepure.net/cdn-cgi/l/email-protection#caa3a4aca58abaa3b2afa4bea5f8fee4a9a5a7"><i
                                        class="fal fa-envelope-open"></i>
                                    <span class="__cf_email__"
                                        data-cfemail="7f161119103f0f16071a110b104d4b511c1012">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="sidebar grey-bg mt-30">
                        <h4 class="sidebar__title">
                            <span><img src="assets/images/shape/heading-shape-3.png" class="mr-5" alt=""></span>
                            Quick Contact
                        </h4>
                        <div class="contact-form contact-form__3">
                            <form action="https://themepure.net/template/pixen/pixen/index.html">
                                ...
                                <button type="submit" class="site-btn site-btn__2 mt-10"><span
                                        class="icon icon__black"><i class="far fa-arrow-right"></i></span> SEnd
                                    messgae</button>
                            </form>
                        </div>
                    </div>
                    <div class="sidebar blue-bg mt-30">
                        <h4 class="sidebar__title sidebar__title--white">
                            <span><img src="assets/images/shape/heading-shape-6.png" class="mr-5" alt=""></span>
                            Design Guideline
                        </h4>
                        <div class="design mt-none-20">
                            <div class="design-item mt-20">
                                <div class="design-item--icon">
                                    <img class="default" src="assets/images/icons/design-1.png" alt="">
                                    <img class="hover" src="assets/images/icons/design-1-h.png" alt="">
                                </div>
                            ...
                            <div class="design-item mt-20">
                                <div class="design-item--icon">
                                    <img class="default" src="assets/images/icons/design-2.png" alt="">
                                    <img class="hover" src="assets/images/icons/design-2-h.png" alt="">
                                </div>
                                <div class="design-item--content">
                            ...
                            <div class="design-item mt-20">
                                <div class="design-item--icon">
                                    <img class="default" src="assets/images/icons/design-3.png" alt="">
                                    <img class="hover" src="assets/images/icons/design-3-h.png" alt="">
                                </div>
                                <div class="design-item--content">
                                    <h4>Jpg file</h4>
                                </div>
                ...
                <div class="col-xl-8">
                    <div class="details-content">
                        <div class="details-content__thumb mb-30">
                            <img src="assets/images/bg/service-details-bg-1.jpg" alt="">
                        </div>
                        ...
                        <div class="row mt-40 mb-35">
                            <div class="col-xl-6">
                                <div class="details-content__thumb">
                                    <img src="assets/images/bg/design-guideline.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6">
                        ...
                        <div class="row mt-35">
                            <div class="col-xl-12">
                                ...
                                <div class="details-content__thumb mt-35 mb-35">
                                    <img src="assets/images/bg/service-details-bg-2.jpg" alt="">
                                </div>
