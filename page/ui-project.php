                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 p-0">
                        <ul class="header__info">
                            ...
                            <li><a href="https://themepure.net/cdn-cgi/l/email-protection#deb7b0b8b19eaeb7a6bbb0aab1eceaf0bdb1b3"><i class="fal fa-envelope-open"></i>
                                    <span class="__cf_email__" data-cfemail="8ce5e2eae3ccfce5f4e9e2f8e3beb8a2efe3e1">[email&#160;protected]</span></a></li>
                        </ul>
                    </div>
                ...
                <div class="col-xl-5 col-lg-6 col-md-6 d-flex align-self-stretch mt-30">
                    <div class="project-item">
                        <div class="project-item__thumb project-item__thumb--big">
                            <img src="assets/images/project/p-10.jpg" alt="">
                        </div>
                ...
                <div class="col-xl-7 mt-30">
                    <div class="row mt-none-30">
                        ...
                        <div class="col-xl-6 col-md-6 col-lg-6 mt-30">
                            <div class="project-item">
                                <div class="project-item__thumb">
                                    <img src="assets/images/project/p-11.jpg" alt="">
                                </div>
                                <div class="project-item__hover" data-overlay="dark" data-opacity="9">
                                    <a href="project-details.html" class="project-item__link"><i
                                            class="far fa-arrow-right"></i></a>
                        ...
                        <div class="col-xl-12 col-md-6 col-lg-12 col-md-12 mt-30">
                            <div class="project-item">
                                <div class="project-item__thumb">
                                    <img src="assets/images/project/p-12.jpg" alt="">
                                </div>
                                <div class="project-item__hover" data-overlay="dark" data-opacity="9">
                                    <a href="project-details.html" class="project-item__link"><i
                                            class="far fa-arrow-right"></i></a>
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="section-header">
                        <h2 class="section-title section-title__white">Need Design Solution <br>
                            For your Brand</h2>
                    </div>
                </div>
                <div class="col-xl-4 text-right">
                    <div class="cta-right">
                        <p>Extra Support</p>
                        <a href="contact.html" class="site-btn site-btn__s3">
